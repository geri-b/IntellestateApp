    ...
    <Container fluid style={{ height: "100%", overflow: 'hidden' }}>
      <Row style={{ height: "100%", overflowY: "auto" }}>
        <Col
          className="left-col"
          md={3}
          style={{ height: "100%", overflowY: "hidden", padding: '10px 0 .75rem 0', background: "linear-gradient(90deg, #123 0%, #203a60 100%)", minWidth: 'min-content' }} // bg #f8f9fa or linear-gradient(180deg, #059 0%, #509 100%)
        >
          <FilterTools
            ref={filterToolsRef}
